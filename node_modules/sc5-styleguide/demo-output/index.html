...
<head>
  ...
  <script>
    var _styleguideConfig = {"title":"SC5 Styleguide","disableEncapsulation":false,"disableHtml5Mode":false,"sideNav":false,"additionalNgDependencies":false};
    (function() {
      'use strict';
      var userStyleFiles = [
          '/styleguide.css',
  ...
  <title ng-bind-html="$root.pageTitle | unsafe">SC5 Styleguide</title>
  
  <script type="text/javascript">
    var filesConfig = [{"name":"sgAppTest","files":["demo/testDirectiveInit.js","demo/testDirective.js","demo/testDirectiveTwo.js"]}];
  </script>
  <base href="/" />
</head>
<body class="sg">
