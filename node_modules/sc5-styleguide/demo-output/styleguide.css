...
@font-face {
  ...
  src: url(''{{{appRoot}}}/assets/fonts'/fontawesome-webfont.eot?v='4.2.0'');
  src: url(''{{{appRoot}}}/assets/fonts'/fontawesome-webfont.eot?#iefix&v='4.2.0'') format('embedded-opentype'),
    url(''{{{appRoot}}}/assets/fonts'/fontawesome-webfont.woff?v='4.2.0'') format('woff'),
    url(''{{{appRoot}}}/assets/fonts'/fontawesome-webfont.ttf?v='4.2.0'') format('truetype'),
    url(''{{{appRoot}}}/assets/fonts'/fontawesome-webfont.svg?v='4.2.0'#fontawesomeregular') format('svg');
  font-weight: normal;
  font-style: normal;
}
.fa {
...
@media screen and (max-width: 768px) {
  .sg.sg-wrapper .sg.sg-side-nav {
    ...
    background: #8b8b8b;
    overflow: scroll;
    -webkit-transition: opacity .4s cubic-bezier(0.000, 0.995, 0.990, 1.000);
...
.sg.sg-header .sg.sg-search-container .sg-hamburger-item {
  ...
  margin-bottom: 9px;
  top: 0;
  -webkit-transition: top 0.1s ease-in-out 0.2s, opacity 0.25s ease-in-out 0.1s, -webkit-transform 0.15s ease-in-out;
  transition: top 0.1s ease-in-out 0.2s, opacity 0.25s ease-in-out 0.1s, -webkit-transform 0.15s ease-in-out;
  transition: transform 0.15s ease-in-out, top 0.1s ease-in-out 0.2s, opacity 0.25s ease-in-out 0.1s;
  transition: transform 0.15s ease-in-out, top 0.1s ease-in-out 0.2s, opacity 0.25s ease-in-out 0.1s, -webkit-transform 0.15s ease-in-out;
...
.sg.sg-header .sg.sg-search-container .sg-hamburger-active .sg-hamburger-item {
  -webkit-transition: top 0.1s ease-in-out, opacity 0.25s ease-in-out, -webkit-transform 0.15s ease-in-out 0.2s;
  transition: top 0.1s ease-in-out, opacity 0.25s ease-in-out, -webkit-transform 0.15s ease-in-out 0.2s;
  transition: transform 0.15s ease-in-out 0.2s, top 0.1s ease-in-out, opacity 0.25s ease-in-out;
  transition: transform 0.15s ease-in-out 0.2s, top 0.1s ease-in-out, opacity 0.25s ease-in-out, -webkit-transform 0.15s ease-in-out 0.2s;
}
...
.sg.disconnection-icon i.fa {
  font-size: 20px;
  -webkit-animation: socket-disconnect-pulse 3s linear infinite;
          animation: socket-disconnect-pulse 3s linear infinite;
}

@-webkit-keyframes socket-disconnect-pulse {
  80% {
